...
\begin{document}
	...
	\end{figure}
	 ...
	 重复十次实验，对每组实验求得的$\gamma$取平均值。求得$\overline{\gamma}=1.3076$,计算与理论值$1.402$的相对误差
	\[E_{x} = \frac{1.402-1.3076}{1.402}=6.73\%\]
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.7\linewidth]{原始数据}
		\caption{原始数据}
	\end{figure}
